...
const AdminCompetitions = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Failed to save result. Please ensure the database table is created.');
    }
  };
    ...
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', margin: 0 }}>Add match records, placements, and medals for athletes.</p>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '2rem' }}>
        ...
        <div className="card">
          <h2 style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1.5rem', fontSize: '1.25rem' }}>
            <Calendar size={20} color="var(--primary)" /> {selectedPlayer ? 'Athlete History' : 'All Competition History'}
          </h2>
